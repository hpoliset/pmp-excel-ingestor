...
<title>Api Access Log Error</title>
...
<script type="text/javascript" src="/pmp/js/errorlogform.js"></script>
<script type="text/javascript" src="/pmp/js/jquery.dataTables.min.js"></script>
</head>
<body>
	<h2 align="center">Request-Response Details</h2>
	<input type="hidden" id="error_log_id" value="<%=request.getParameter("id")%>">
	<table class="responstable" id="errorlogtable" width="100%">
		<thead>
			<tr>
				<th>Sr.No</th>
				<th>Error Message</th>
