...
<script type="text/javascript" language="javascript">
	$(document)
			.ready(
					function() {
						var url = 'http://localhost:8080/pmp/api/authenticate';
						var getuserurl = 'http://localhost:8080/pmp/api/v1/user';
						var id;
						$("#submit")
								.click(
										function() {
										...
										function() {
											...
											if (password != confirmPassword) {
												...
												return false;
													...
													$
															.ajax({
																url : "http://localhost:8080/pmp/api/users",
																type : "POST",
																/* async : false, */
																contentType : "application/json",
																dataType : "json",
				...
				<section class="popupBody">
					...
					<div class="social_login">
						<div align="center" class="row">
							...
							<form:form method="POST" action="/pmp/index" id="index" modelAttribute="user">
								<form:input id="id" name="id" type="hidden" path="id"/> <form:input
									id="first_name" name="first_name" type="hidden" path="first_name"/> <form:input
									id="last_name" name="last_name" type="hidden" path="last_name"/> <form:input
									id="email" name="email" type="hidden" path="email"/> <form:input
									id="gender" name="gender" type="hidden"  path="gender"/> <form:input
									id="mobile" name="mobile" type="hidden" path="mobile"/> <form:input
									id="address" name="address" type="hidden" path="address"/> <form:input
									id="country" name="country" type="hidden" path="country"/> <form:input
									id="state" name="state" type="hidden" path="state"/> <form:input id="city"
									name="city" type="hidden" path="city"/>
									<form:input id="access_token" name="access_token" path="access_token"  type="hidden"/>
									 <input type="hidden"
									value="Submit" id="indexbtn" class="button-primary" />
							</form:form>
						</div>
										...
										<table width="400" height="100">
											...
											<tr>
												...
												<td><input name="firstName" id="firstname" type="text"
													class="four columns" placeholder="Enter FirstName"></td>
											</tr>
											<tr>
												<td>Last Name<span class="mandatory"> *</span></td>
											...
											<tr>
												<td>Password<span class="mandatory"> *</span></td>
												<td><input name="password" id="password1"
														class="four-columns" placeholder="Enter Password"
														type="password"></td>
											</tr>
