		...
		<form:form method="POST" action="createEvent" modelAttribute="program"
			...
			<div class="row">
				...
				<div class="four columns">
					...
					<label for="channel">Program Name </label>
					<form:input class="u-full-width" type="text"
						placeholder="Enter Program Channel" id="programName"
			...
			<div class="row">
				<div class="twelve columns">
					...
					<form:textarea path="remarks" class="u-full-width" id="remarks"
						...
						<form:hidden path="autoGeneratedEventId"/>
                		<form:hidden path="autoGeneratedIntroId"/>
				</div>
			
			</div>

			<div class="row" align="right" style="padding-left: 180px">

				<div class="six columns" align="right" >
					<input class="button-primary" type="submit" value="Save changes" align="middle"/>
				</div>
