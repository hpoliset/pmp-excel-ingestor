...
/**
 * Constant class to hold the messages, keywords,sub-keywords for the SMS
 * integration.
 * 
 * @author rramesh
 *
...
public class SMSConstants {
	...
	/** Holds the Heartfulness home page URL */
	public static final String SMS_HEARTFULNESS_UPDATEEVENT_URL 								= 	"https://en.heartfulness.org/eventcentral/#/login?id=";
	public static final String DASHBOARD_v2_HEARTFULNESS_UPDATEEVENT_URL 						= 	"http://eventcentralnew.heartfulness.org/Events/ViewEvent?eventid=";
	...
	public static final String SMS_GOOGLE_MAPS_API_PART_1 										= 	"http://maps.google.com/maps/api/geocode/json?address=";
	public static final String SMS_GOOGLE_MAPS_API_PART_2 										= 	"&components=postal_code:";
	public static final String SMS_GOOGLE_MAPS_API_PART_3 										= 	"&sensor=false";
}
