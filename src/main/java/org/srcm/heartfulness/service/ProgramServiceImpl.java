		...
		for(Event event :events){
			...
			if(!errors.isEmpty()){
				...
				try {
					...
					//program.setProgramStartDate(null);
					throw new InvalidDateException("Error while parsing Program Start Date");
				}
				...
				if(null == event.getProgramEndDate()){
					...
					try {
						...
						//program.setProgramEndDate(null);
						throw new InvalidDateException("Error while parsing Program End Date");
					}
				}
