			...
			if (!errors.isEmpty()) {
				...
				if(null != program.getCoordinatorEmail() || program.getCoordinatorEmail().isEmpty()){
					...
					if(null == isCoordinatorEmailIdvalid){
						System.out.println("Need to send mail to coordinator with link to access to dashboard..");
					}else{
						System.out.println("Need to send mail to coordinator to create profile with MYSRCM..");
					}
				}
