...
public class ProgramServiceImpl implements ProgramService {
			...
			if (!errors.isEmpty()) {
				...
				if(null != event.getAutoGeneratedEventId() && !event.getAutoGeneratedEventId().isEmpty()){
					...
					if(!pgm.getPreceptorIdCardNumber().equalsIgnoreCase(event.getPreceptorIdCardNumber())){
						...
						String preceptorIdValidationResponse= validatePreceptorIDcardNumber(program,event,accessdetailsID);
	...
	private String validatePreceptorIDcardNumber(Program program, Event event, int accessdetailsID) throws HttpClientErrorException, JsonParseException, JsonMappingException, IOException {
