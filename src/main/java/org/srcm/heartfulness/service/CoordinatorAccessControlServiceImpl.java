...
public class CoordinatorAccessControlServiceImpl implements CoordinatorAccessControlService {
	 ...
	 * 
	 * @param autoGeneratedEventId
	 *            to get the programId of an event.
	 * @param accessLog
	 *            to update the PMP API access log data.
	 ...
	 */
	@Override
	public ResponseEntity<?> getListOfSecondaryCoordinatorRequests(String autoGeneratedEventId,
		...
		List<SecondaryCoordinatorRequest> listOfSecondaryCoordinators = coordntrAccssCntrlRepo
				.getListOfRequests(program.getProgramId());
		accessLog.setStatus(ErrorConstants.STATUS_SUCCESS);
		accessLog.setErrorMessage("");
		accessLog.setTotalResponseTime(DateUtils.getCurrentTimeInMilliSec());
