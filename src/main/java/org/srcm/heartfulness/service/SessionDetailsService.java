...
public interface SessionDetailsService {
	 ...
	 * 
	 * @param sessionDetails to get the auto generated session id
	 ...
	 * 
	 * @param programId to get the session list for a particular event.
	 * @param eventId to set the event details for all session details.
