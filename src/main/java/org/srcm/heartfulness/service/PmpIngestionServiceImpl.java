	...
	private void validatePreceptorID(Program program) {
		...
		try {
			accessLog = new PMPAPIAccessLog(null, null, "EXCEL UPLOAD", DateUtils.getCurrentTimeInMilliSec(), null,
					ErrorConstants.STATUS_FAILED, null, StackTraceUtils.convertPojoToJson("EventID:"+program.getAutoGeneratedEventId()+" ,Program channel:"+program.getProgramChannel()+" ,Coordinator Email:"+program.getCoordinatorEmail()+" ,Preceptor Id: "+program.getPreceptorIdCardNumber()), null);
