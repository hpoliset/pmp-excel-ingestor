...
public interface ProgramService {
	...
	/**
	 * Retrieve <code>List<Event></code> from the data store by values given in the search request.
	 * @param searchRequest
	 * @return
	 */
	...
	/**
	 * Retrieve <code>Auto generated eventId</code> from the data store by programId.
	 * @param programId
	 * @return
	 */
