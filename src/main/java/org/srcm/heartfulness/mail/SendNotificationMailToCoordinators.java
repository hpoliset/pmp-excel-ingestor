	...
	public void sendNotificationMailToCoordinators(String coordinatorName, String coordinatorEmail,	List<Program> programList) throws MessagingException, UnsupportedEncodingException {
			...
			if (!programList.isEmpty()) {
				...
				for (Program program : programList) {
					...
					sb.append("</td><td>");
					String dashboardUrl = "";
					if(null != program.getCreatedSource() && program.getCreatedSource().equals(PMPConstants.CREATED_SOURCE_DASHBOARD)){
					...
					sb.append(program.getAutoGeneratedEventId() != null ? "<a href=\""+dashboardUrl+"?id="+program.getAutoGeneratedEventId()+"\">"+program.getAutoGeneratedEventId()+"</a>" : "");
