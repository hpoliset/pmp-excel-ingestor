	...
	public void sendNotificationMailToCoordinators(String coordinatorName, String coordinatorEmail,	List<Program> programList) throws MessagingException, UnsupportedEncodingException {
			...
			if (!programList.isEmpty()) {
				...
				for (Program program : programList) {
					...
					sb.append(serialNo++);
					sb.append("</td><td>");
					sb.append(program.getAutoGeneratedEventId() != null ? "<a href=\"" + 
							null != program.getCreatedSource() ?  program.getCreatedSource().equals(PMPConstants.CREATED_SOURCE_DASHBOARD) 
									? SMSConstants.SMS_HEARTFULNESS_UPDATEEVENT_URL : SMSConstants.DASHBOARD_v2_HEARTFULNESS_UPDATEEVENT_URL 
											: SMSConstants.SMS_HEARTFULNESS_UPDATEEVENT_URL+"?id="+program.getAutoGeneratedEventId() 
											+ "\">"+program.getAutoGeneratedEventId()+"</a>" : "");
					sb.append("</td><td>");
