...
@JsonPropertyOrder({ "autoGeneratedEventId", "programChannel", "programStartDate", "programEndDate", "programZone",
		...
		"welcomeCardSignerIdCardNumber", "remarks", "isEwelcomeIdGenerationDisabled","status","isReadOnly", "errors" })
public class Event {
	...
	public String toString() {
		return "Event [autoGeneratedEventId=" + autoGeneratedEventId + ", autoGeneratedIntroId=" + autoGeneratedIntroId
				...
				+ ", remarks=" + remarks + ", status=" + status + ", abhyasiID=" + abhyasiID
