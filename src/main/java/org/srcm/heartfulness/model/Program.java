...
public class Program {
	...
	public String toString() {
		return "Program [programId=" + programId + ", encryptedId=" + encryptedId + ", programHashCode="
				...
				+ ", programStartDate=" + programStartDate + ", programEndDate=" + programEndDate
				...
				+ ", remarks=" + remarks + ", createTime=" + createTime + ", updateTime=" + updateTime + ", createdBy="
				+ createdBy + ", updatedBy=" + updatedBy + ", autoGeneratedEventId=" + autoGeneratedEventId
				...
				+ srcmGroup + ", prefectId=" + firstSittingBy + ", abyasiRefNo=" + abyasiRefNo + "]";
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((autoGeneratedEventId == null) ? 0 : autoGeneratedEventId.hashCode());
		result = prime * result + ((eventPlace == null) ? 0 : eventPlace.hashCode());
		result = prime * result + ((programChannel == null) ? 0 : programChannel.hashCode());
		result = prime * result + programId;
		result = prime * result + ((programStartDate == null) ? 0 : programStartDate.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (autoGeneratedEventId == null) {
			if (other.autoGeneratedEventId != null)
				return false;
		} else if (!autoGeneratedEventId.equals(other.autoGeneratedEventId))
			return false;
		if (eventPlace == null) {
			...
			return false;
		if (programChannel == null) {
			if (other.programChannel != null)
				return false;
		} else if (!programChannel.equals(other.programChannel))
			return false;
