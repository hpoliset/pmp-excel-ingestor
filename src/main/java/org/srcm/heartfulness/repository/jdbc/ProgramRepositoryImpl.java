...
public class ProgramRepositoryImpl implements ProgramRepository {
	...
	public void saveWithProgramName(Program program) {
		...
		/*
		 * // Find if there is an existing program row if
		 * (program.getProgramId() == 0) { int programId =
		 * this.jdbcTemplate.query(
		 * "SELECT program_id from program where program_name=?", new
		 * Object[]{program.getProgramName()}, new ResultSetExtractor<Integer>()
		 * {
		 * 
		 * @Override public Integer extractData(ResultSet resultSet) throws
		 * SQLException, DataAccessException { if (resultSet.next()) { return
	...
	/**
	 * gets the count of the events available for the given mail and based on user role
	 * @param email
	 * @param isAdmin
	 * @return
	 */
	...
	/**
	 * gets the count of un-categorized events for the given email and based on user role
	 * @param email
	 * @param isAdmin
	 * @return
	 */
	...
	/**
     * gets the count of miscellaneous events for the given email and based on user role
     * @param email
     * @param isAdmin
	...
	/**
	 * update the co-ordinator details in the datbase after changing the admin for the event
	...
	/**
	 * updates the participant introduced status for the given participant Ids of the goven eventId
	...
	/**
	 *  gets the count of un-catgorized events for the given email and based on user role
	 * @param username
	 * @param isAdmin
	 * @return List<String>
	 */
