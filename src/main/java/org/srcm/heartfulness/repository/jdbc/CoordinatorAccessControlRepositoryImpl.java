...
public class CoordinatorAccessControlRepositoryImpl implements CoordinatorAccessControlRepository {
	...
	public Program getProgramIdByEventId(String autoGeneratedEventId) {
		...
		program = this.namedParameterJdbcTemplate
				.queryForObject(
						"SELECT program_id,coordinator_name,coordinator_email,preceptor_id_card_number FROM program WHERE auto_generated_event_id=:auto_generated_event_id",
	...
	public List<SecondaryCoordinatorRequest> getListOfRequests(int programId) {
		...
		secondaryCoordinatorList = this.jdbcTemplate.query("SELECT auto_generated_request_id,status, "
				+ "requested_by,request_time " + "FROM event_access_request " + "WHERE program_id = ?",
				new Object[] { programId }, new ResultSetExtractor<List<SecondaryCoordinatorRequest>>() {
					@Override
