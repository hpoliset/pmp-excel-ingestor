...
public class ParticipantsController {
	...
	public ResponseEntity<?> getParticipantList(@RequestHeader(value = "Authorization") String token,
			@RequestBody(required = true) Event event, @Context HttpServletRequest request) throws ParseException {
		...
		try {
			...
			if (null == userProfile) {
				...
				apiAccessLogService.createLogDetails(null, request.getRemoteAddr(), request.getRequestURI(),
						requestTime);
			...
			if (null == event.getAutoGeneratedEventId() || event.getAutoGeneratedEventId().isEmpty()) {
				...
				apiAccessLogService.createLogDetails((null == userProfile ? null : userProfile.getEmail()),
						request.getRemoteAddr(), request.getRequestURI(), requestTime);
			...
			apiAccessLogService.createLogDetails((null == userProfile ? null : userProfile.getEmail()),
					request.getRemoteAddr(), request.getRequestURI(), requestTime);
			LOGGER.debug("Method end..... " + DateUtils.getCurrentTimeInMilliSec());
			...
			apiAccessLogService.createLogDetails(null, request.getRemoteAddr(), request.getRequestURI(), requestTime);
			return new ResponseEntity<ErrorResponse>(eResponse, HttpStatus.UNAUTHORIZED);
	...
	public ResponseEntity<?> getPaticipantDetails(@RequestBody ParticipantRequest request,
		...
		try {
			...
			if (null == userProfile) {
				...
				apiAccessLogService.createLogDetails(null, httpRequest.getRemoteAddr(), httpRequest.getRequestURI(),
						requestTime);
	...
	public ResponseEntity<?> createParticipant(@RequestBody ParticipantRequest participant,
			@RequestHeader(value = "Authorization") String token, @Context HttpServletRequest request)
			throws ParseException {
		String requestTime = DateUtils.getCurrentTimeInMilliSec();
		UserProfile userProfile = null;
		try {
	...
	public ResponseEntity<?> searchEvents(@RequestHeader(value = "Authorization") String token,
			@RequestBody SearchRequest searchRequest, @Context HttpServletRequest request) throws ParseException {
		String requestTime = DateUtils.getCurrentTimeInMilliSec();
		UserProfile userProfile = null;
		try {
