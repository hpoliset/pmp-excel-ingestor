...
public class ParticipantsController {
	...
	public ResponseEntity<?> getParticipantList(@RequestHeader(value = "Authorization") String token,
		...
		try {
			...
			accessLog.setUsername((null == userProfile.getUser_email() || userProfile.getUser_email().isEmpty()) ? userProfile.getEmail() : userProfile.getUser_email());
			...
			participantList = programService.getParticipantByEventId(event.getAutoGeneratedEventId(),
					(null == userProfile.getUser_email() || userProfile.getUser_email().isEmpty()) ? userProfile.getEmail() : userProfile.getUser_email());
