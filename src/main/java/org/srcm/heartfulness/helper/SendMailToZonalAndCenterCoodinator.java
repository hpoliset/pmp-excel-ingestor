...
public class SendMailToZonalAndCenterCoodinator {
	...
	private void sendNotificationMailToZoneAndCenterCoordinator(){
		...
		LOGGER.info("ZONE:Size of the zone wise program list where mail sent to zonal coordinator = 0 is {}",listOfProgramsZoneWise.size());
		...
		if(!listOfProgramsZoneWise.isEmpty()){
			...
			LOGGER.info("ZONE:Size of programs zone wise where mail sent to zonal coordinator is 0 {}",zoneWiseDetails.size());
		...
		if(!listOfProgramsCenterWise.isEmpty()){
			...
			centerWiseDetails.forEach(  (zone,pgrmListCenterWise)->pgrmListCenterWise.forEach( pgrm -> LOGGER.info("Zone : {},Program Id {},Program Channel {},"
					+"Program Start Date={},Program Zone={},program center={},Program Status={}",zone,pgrm.getAutoGeneratedEventId(),pgrm.getProgramChannel()
					,pgrm.getProgramStartDate(),pgrm.getProgramZone(),pgrm.getProgramCenter(),pgrm.getProgramStatus())
					));
